...
<div class="container">
  ...
  <form name="myform" action="">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="username" placeholder="Name" name="username" onChange="uname();" required>
    </div>
  <div class="form-group">
      <label for="address">Address:</label>
      <textarea  class="form-control" id="address" placeholder="Address" name="address" onChange="adfn();" required></textarea>
    </div>
  <div class="form-group">
      <label for="phone">Mobile:</label>
      <input type="number" class="form-control" id="phone" placeholder="Mobile" name="phone" onChange="mob();" required>
    </div>
  <div class="form-group">
      <label for="email">Email:</label>
      <input type="email" class="form-control" id="email" placeholder="Email" name="email" onChange="efn();" required>
    </div>
  <div class="form-group">
      <label for="place">Place:</label>
      <input type="place" class="form-control" id="place" placeholder="Place" name="place" onChange="sfn();" required>
    </div>
  <div class="form-group">
