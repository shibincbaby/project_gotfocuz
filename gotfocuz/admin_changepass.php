...
function validation()
{
	...
	<?php
 //Developed by www.freestudentprojects.com
include("dbcon.php");
if(isset($_POST[submit]))
{
		$result = mysqli_query($con,"UPDATE `tbl_user` SET password='$_POST[npassword]' where username='$_POST[emailid]' AND password='$_POST[opassword]'");
...
$sqlview = "SELECT * FROM `tbl_user` WHERE username='$_SESSION[username]'";
$qresult = mysqli_query($connection,$sqlview);
