...
<?php
	...
	if(isset($_POST['submit']))
    {
		...
		if($row['email']!="")
		{
			...
			$headers .= 'From: <info.gotfocuz@gmail.com>' . "\r\n";
			$headers .= 'Cc: info.gotfocuz@gmail.com' . "\r\n";
...
<head>
  <meta charset="UTF-8">
  <title>Forgot Acccount Password Recovery</title>
...
<div class="container">
		...
		<form action="forgot.php" method="post" name="mform">
			...
			<p>	<input type="text" placeholder="E-mail" required="" id="username" name="user" /></p>
